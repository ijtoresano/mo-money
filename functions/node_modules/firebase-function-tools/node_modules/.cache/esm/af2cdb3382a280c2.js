let database,admin;_82a‍.x([["default",()=>_82a‍.o]]);_82a‍.w("firebase-functions",[["database",["database"],function(v){database=v}]]);_82a‍.w("firebase-admin",[["default",["admin"],function(v){admin=v}]]);
      ...
      snapshot.forEach(userRoles => {
        ...
        Object.keys(roles).forEach((key, index) => {
          if (key === roleUid) {
            ...
            _82a‍.g.console.log('User role changed:', eventSnapshot.val())
            ...
            _82a‍.g.console.log('Role changed', userUid, roleUid, grantUid)
          }
        })
      })
