let functions,admin,moment,nodemailer,notifications;_ff8‍.x([["default",()=>_ff8‍.o]]);_ff8‍.w("firebase-functions",[["*",null,function(v){functions=v}]]);_ff8‍.w("firebase-admin",[["default",["admin"],function(v){admin=v}]]);_ff8‍.w("moment",[["default",["moment"],function(v){moment=v}]]);_ff8‍.w("nodemailer",[["default",["nodemailer"],function(v){nodemailer=v}]]);_ff8‍.w("firebase-function-tools/lib/notifications",[["default",["notifications"],function(v){notifications=v}]]);
...
_ff8‍.d(functions
  ...
  .onCreate((eventSnapshot, context) => {
    _ff8‍.g.console.log('authType', context.authType)
    ...
    _ff8‍.g.console.log('values', eventSnapshot.val())
    console.log(
