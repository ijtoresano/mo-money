let database,admin,moment,usersUtil;_f04‍.x([["default",()=>_f04‍.o]]);_f04‍.w("firebase-functions",[["database",["database"],function(v){database=v}]]);_f04‍.w("firebase-admin",[["default",["admin"],function(v){admin=v}]]);_f04‍.w("moment",[["default",["moment"],function(v){moment=v}]]);_f04‍.w("firebase-function-tools/lib/users",[["default",["usersUtil"],function(v){usersUtil=v}]]);




_f04‍.d(database.ref('/users_count').onDelete((data, context) => {
